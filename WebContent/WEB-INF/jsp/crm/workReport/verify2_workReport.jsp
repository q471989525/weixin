					...
					<table style="width:100%;" border="0" cellspacing="0" cellpadding="0" class="formtable">
					        <tbody>
					            ...
					            <tr>
					                ...
					                <td colspan="3">
					                	<textarea rows="10" style="width: 80%;border: 0px;overflow: hidden;" id="workContent" name="workContent">${workReport.workContent}</textarea>
					                </td>
					            </tr>
					            <c:if test="${workReport.verifyFlag eq 'y'}">
					            <tr>
					                <td class="tdTitle">审核内容：</td>
					                <td colspan="3">
					                	<textarea rows="5" style="width: 80%;border: 0px;overflow: hidden;" id="verifyDesc2" name="verifyDesc2">${workReport.verifyDesc}</textarea>
					                </td>
					            </tr>
					            </c:if>
					            <c:if test="${workReport.verifyFlag ne 'y' and viewFlag eq 'all'}">
					            <tr>
