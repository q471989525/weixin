...
<!-- Flexible video -->
<script src="common/jscript/wx/jquery.fitvids.js"></script>
...
<body id="page">
	...
	<div id="pagecontainer">
    	...
    	<div id="pages_nav">
   	  ...
   	  <div class="content">
        <h1>Flexible video</h1>
        <span class="subtitle_descr">Consectetur adipisicing elit, sed do eiusmod tempor incididunt</span>
        
        <div class="videocontainer">
        <iframe src="http://player.vimeo.com/video/9009677?title=0&amp;byline=0&amp;portrait=0" width="400" height="225" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe>
        </div>
