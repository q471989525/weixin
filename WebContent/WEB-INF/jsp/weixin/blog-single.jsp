...
<body id="page">
	...
	<div id="pagecontainer">
    	...
    	<div id="header" class="black_gradient">
            ...
            <div class="page_title">Blog single</div>
        ...
        <div class="post">
            ...
            <img src="common/images/wx/pic.jpg" alt="" title="" border="0" class="rounded" />
		...
		<div id="tab3" class="tabcontent">
			<h3>Social</h3>
            <ul class="social">
			<li><a href="#"><img src="common/images/wx/social/rss.png" alt="" title="" border="0" class="rounded-half" /></a></li>
            <li><a href="#"><img src="common/images/wx/social/twitter.png" alt="" title="" border="0" class="rounded-half" /></a></li>
            <li><a href="#"><img src="common/images/wx/social/facebook.png" alt="" title="" border="0" class="rounded-half" /></a></li>
            <li class="right"><a href="#"><img src="common/images/wx/social/digg.png" alt="" title="" border="0" class="rounded-half" /></a></li>
            
			<li><a href="#"><img src="common/images/wx/social/google.png" alt="" title="" border="0" class="rounded-half" /></a></li>
            <li><a href="#"><img src="common/images/wx/social/flickr.png" alt="" title="" border="0" class="rounded-half" /></a></li>
            <li><a href="#"><img src="common/images/wx/social/reddit.png" alt="" title="" border="0" class="rounded-half" /></a></li>
            <li class="right"><a href="#"><img src="common/images/wx/social/vimeo.png" alt="" title="" border="0" class="rounded-half" /></a></li>
            </ul>
			<div class="clear"></div>
		</div> 
