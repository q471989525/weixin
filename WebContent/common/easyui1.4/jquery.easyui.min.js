...
},message:"请输入有效的电子邮件地址."},url:{validator:function(_44d){
...
},message:"请输入有效的URL地址."},length:{validator:function(_44e,_44f){
var len=$.trim(_44e).length;
return len>=_44f[0]&&len<=_44f[1];
},message:"输入内容长度必须介于{0}和{1}之间."},remote:{validator:function(_450,_451){
var data={};
data[_451[1]]=_450;
