...
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/common/zTree_v3/css/default.css">
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/common/zTree_v3/css/zTreeStyle/zTreeStyle.css">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/common/zTree_v3/js/jquery.ztree.all-3.5.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/common/jscript/common.js"></script>
